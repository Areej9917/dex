                ...
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <a href="{{route('permissions')}}" class="button btn-md btn-primary p-2"><i class="fa fa-arrow-left"> Back </i> </a>
                        </div>
                    </div>
                </div>

                <div class="container-fluid bg-white p-3">
                    <form method="post" action="{{route('permission_update')}}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="position-relative form-group">
                                    ...
                                    <input name="name" id="name" placeholder="Permission Code" disabled type="text" required class="form-control" value="{{ $permission->name }}">
                                </div>
                            ...
                            <div class="col-6">
                                <div class="position-relative form-group">
                                    ...
                                    <input name="display_name" id="display_name" placeholder="Permission Name" type="text" value="{{ $permission->display_name }}" required class="form-control">
                                </div>
