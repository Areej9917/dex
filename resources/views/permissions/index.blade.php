...
@section('main-content')
    <script type="text/javascript">
        ...
        function deletePermission(id) {
            ...
            $('#delete_permission_modal').appendTo("body")
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <a href="{{route('permission_create')}}" class="button btn-md btn-primary p-2"><i class="fa fa-plus"> Add Permission </i> </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid bg-white p-3">
                    ...
                    <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center ">
                                <a href="{{route('permission_edit',$permission->id)}}" class="fa fa-pencil-alt  text-success pr-2"></a>
                                <a href="javascript:void(0);" onclick="deletePermission({{$permission->id}})" class="fa fa-trash text-danger pl-3"></a>
                            </td>
                    ...
                    <div class="modal" id="delete_permission_modal" tabindex="-1" role="dialog">
