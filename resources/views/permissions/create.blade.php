        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <div class="container-fluid bg-white p-3">
                    ...
                    @endif
                    <form method="post" action="{{route('permission_save')}}">
                        @csrf
                        <div class="row">
                            <div class="col-6">
                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class=""> Code (Cannot be updated)</label>
                                    <input name="name" id="name" placeholder="Permission Code" type="text" required class="form-control" value="{{ old('name') }}">
                                </div>
                            ...
                            <div class="col-6">
                                <div class="position-relative form-group">
                                    ...
                                    <input name="display_name" id="display_name" placeholder="Permission display Name" type="text" value="{{ old('display_name') }}" required class="form-control">
                                </div>
