                ...
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <a href="{{route('roles.index')}}" class="button btn-md btn-primary p-2"><i class="fa fa-arrow-left"> Back </i> </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="position-relative form-group">
                                    ...
                                    <input name="name" id="name" placeholder="Role Code" type="text" required class="form-control" value="{{ old('name') }}">
                                </div>
                            ...
                            <div class="col-6">
                                <div class="position-relative form-group">
                                    ...
                                    <input name="display_name" id="display_name" placeholder="Role Name" type="text" value="{{ old('display_name') }}" required class="form-control">
                                </div>
