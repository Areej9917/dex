                                                ...
                                                <div class="menu-header-content text-left">
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left">
                                                                <div class="widget-heading"> {{ Auth::user()->username}}
                                                                </div>
                ...
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <a href="{{route('roles')}}" class="button btn-md btn-primary p-2"><i class="fa fa-arrow-left"> Back </i> </a>
                        </div>
                    </div>
                </div>

                <div class="container-fluid bg-white p-3">
                    <form method="post" action="{{route('role_update')}}">
                        @csrf
                        <div class="row">
                            <input type="hidden" name="id" value="{{$role->id}}"/>
                            <div class="col-6">
                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class=""> Code (Cannot be updated)</label>
                                    <input name="name" id="name" disabled placeholder="Role Code" type="text" required class="form-control" value="{{ $role->name }}">
                                </div>

                            </div>
                            <div class="col-6">
                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class=""> Display Name </label>
                                    <input name="display_name" id="display_name" placeholder="Role Name" type="text" value="{{ $role->display_name }}" required class="form-control">
                                </div>
                                        ...
                                        @foreach($permissions as $index => $permission)
                                            ...
                                            <div class="col-3">
                                                    ...
                                                    <input type="checkbox" name="permissions[]"   value="{{$permission->id}}"
                                                        ...
                                                        @foreach($role->permissions as $userRole)
                                                            @if($userRole->id==$permission->id) {{"checked"}}
                                                                @endif
                                                            @endforeach
                                                        @endif
