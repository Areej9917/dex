...
<head>
    ...
    <link href="{{ asset('css/select2-bootstrap4.min.css') }}" type="text/css" rel="stylesheet">
    ...
    @yield('css')
    <link href="{{asset('css/custom-styles.css')}}" rel="stylesheet"></head>
...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
    <div class="app-header header-shadow">
                                                        ...
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <img width="42" class="rounded-circle"
                                                                     src="{{asset('assets/images/avatars/images1.png')}}"
                                                                     alt="">
                                                            </div>
                                                            <div class="widget-content-left">
                                        ...
                                        <div class="scroll-area-xs" style="height: 100px;">
                                            <div class="scrollbar-container ps">
                                                <ul class="nav flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="{{route('user.change-password')}}" class="nav-link">Change Password
                                                        </a>
                                                    </li>
     ...
     <div class="app-main">
            ...
            <!-- <div class="app-main__outer" style="width: calc(100% - 310px);"> -->
            <div class="app-main__outer" style="width: calc(100% - 0px);">
...
includeSelectAllOption: true
    ...
    let id = $('.mm-active').attr("data-id")
    $('.li_'+id).addClass("mm-active")
    $('.ul_'+id).addClass("mm-show")
